-- scripts/153_add_resident_name_to_units.sql
-- เพิ่มคอลัมน์ resident_name ในตาราง units สำหรับเก็บชื่อจริงของผู้อาศัย
...
-- ========================================
-- ขั้นตอนที่ 2: ตรวจสอบข้อมูลปัจจุบัน (หลังเพิ่มคอลัมน์)
-- ========================================
SELECT 
  id,
  unit_number,
...
-- ========================================
-- ขั้นตอนที่ 3: อัปเดต resident_name ด้วยชื่อจริงของผู้อาศัยแต่ละคน
-- ========================================
...
-- ========================================
-- ขั้นตอนที่ 4: อัปเดตชื่อจาก email (ถ้าไม่มีชื่อจริง)
-- ========================================
UPDATE units 
SET resident_name = CASE 
...
-- ========================================
-- ขั้นตอนที่ 6: สร้าง View สำหรับแสดงข้อมูลผู้อาศัยที่สมบูรณ์
-- ========================================
...
-- ========================================
-- ขั้นตอนที่ 7: ทดสอบ View
-- ========================================
SELECT * FROM resident_info ORDER BY unit_number;

-- ========================================
-- ขั้นตอนที่ 8: ตรวจสอบข้อมูลสุดท้าย
-- ========================================
SELECT 
