-- Add Advanced Analytics Module to All User Groups
-- This script adds the 'advanced_analytics' module to all existing user groups

SELECT 
  '===== ADDING ADVANCED ANALYTICS MODULE TO ALL USER GROUPS =====' as debug_info;
...
-- 2. Add advanced_analytics module to all active groups (Global permissions)
...
-- 3. Add advanced_analytics module to all active groups (Project-specific permissions)
INSERT INTO user_group_permissions (
  user_group_id,
  module,
  can_access,
...
SELECT 
  'After Adding Advanced Analytics Module' as check_type,
  ug.name as group_name,
  ug.display_name,
  COUNT(ugp.module) as total_permissions,
  COUNT(CASE WHEN ugp.module = 'advanced_analytics' THEN 1 END) as advanced_analytics_permissions,
...
-- 5. Show advanced_analytics module permissions specifically
SELECT 
  'Advanced Analytics Module Permissions' as check_type,
  ug.name as group_name,
  ug.display_name,
  ugp.can_access,
  ugp.can_view,
...
WHERE ug.is_active = true
  AND ugp.module = 'advanced_analytics'
