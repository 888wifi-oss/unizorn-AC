-- ตรวจสอบและแก้ไขปัญหาเมนูไม่แสดงตาม User Group
-- Debug and fix menu display based on User Group permissions
...
WHERE u.email LIKE '%@%'  -- ตรวจสอบ user ที่มี email
ORDER BY u.email, r.name;

-- 2. ตรวจสอบ user group memberships
SELECT 
...
-- 3. ตรวจสอบ user group permissions
SELECT 
